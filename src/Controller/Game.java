...
public class Game implements Serializable {
  ...
  private void init() {
    Game restartedGame = GameFileBuilder.loadGameInfo(this.gameName);
    restartedGame.start();
  }
